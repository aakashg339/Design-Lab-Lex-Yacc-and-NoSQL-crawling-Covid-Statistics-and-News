...
#     '''portionToExtract : OPENHTHREE CONTENT CONTENT CLOSEHTHREE dataToExtract'''
...
def p_content(p):
    ...
    # Check if the valueString is already present in the list. If not then append it to the list
    if valueString not in valueList:
